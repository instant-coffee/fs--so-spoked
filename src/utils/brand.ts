...
export const DISPLAY_FONTS: Record<"serif" | "sansSerif", string[]> = {
  serif: ["Playfair Display", "Cormorant Garamond", "DM Serif Display", "Lora"],
  sansSerif: ["Bebas Neue", "Oswald", "Barlow Condensed"],
};

export const BODY_FONTS: Record<"serif" | "sansSerif", string[]> = {
  serif: ["Lora", "Merriweather", "EB Garamond"],
  sansSerif: ["Space Grotesk", "Didact Gothic", "Inter", "DM Sans", "Nunito"],
};
